...
# **which are the most movies or TV shows ?**
...
fig6 = px.bar(df6, x="Tv show", y= 'count',color_discrete_sequence=['#8B0000'] )              ###plot it with plotly
...
fig7 = px.bar(df7, x="movies", y= 'count',color_discrete_sequence=['#8B0000'] )           ###plot it with plotly
